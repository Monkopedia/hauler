...
`hauler` 0.4.2 depends on `com.monkopedia.ksrpc:ksrpc-core:1.1.4` (stable),
built with Kotlin 2.4.10. ksrpc is API-stable under semver from 1.0.0 onward.

If your project applies the `com.monkopedia.ksrpc.plugin` Gradle plugin
directly, also bump it to `1.1.4`. If you reference `ksrpc-sockets` /
